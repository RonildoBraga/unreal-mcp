...
├── LICENSE                                     MIT (preserves upstream)
├── mcp.json                                    example MCP-client registration
├── Docs/
│   ├── CONTRIBUTING.md                         this file
│   ├── README.md                               doc-section landing
│   └── Tools/                                  per-category tool reference
├── MCPGameProject/                             sample UE 5.7 project
│   ├── MCPGameProject.uproject
│   ├── Config/
│   ├── Source/
│   └── Plugins/
│       └── UnrealMCP/                          THE PLUGIN — source of truth
│           ├── UnrealMCP.uplugin
│           └── Source/UnrealMCP/
│               ├── Private/Commands/           handler implementations
│               ├── Public/Commands/            handler headers
│               ├── Private/UnrealMCPBridge.cpp dispatch + TCP server
│               └── Public/UnrealMCPBridge.h
└── Python/
    ├── pyproject.toml
    ├── unreal_mcp_server.py                    FastMCP server, registers tools
    └── tools/
        ├── asset_tools.py                      Sprint 1 — asset registry
        ├── editor_tools.py                     actor + viewport
