...
private:
    ...
    // Phase 5.3 UMG endpoint extensions (Lauder project, ~435 lines in the .cpp).
    // These handlers add path-flexible widget placement, dynamic widget property
    // setters, and a compile entry-point — used by Lauder's HUD work and any
    // dynamic-widget workflow.
